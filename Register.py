...
lbl_details = Label(register, text="Personal Details", fg="#206F3D", bg="#EBFFEC", font="Purisa 20")
...
lbl_nextOK = Label(register, text="Next of Kin Details", fg="#206F3D", bg="#EBFFEC", font="Purisa 20")
